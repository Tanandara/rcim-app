...
function printReport() {
    ...
    newWin.document.write(
        ...
        "<style>@font-face {font-family: 'cloud';src:url('fonts/Cloud-Light.otf');}li,p,h2,h3,h1,h4,div{font-family: 'cloud' !important;}@media print { *{ font-size:10px !important;-webkit-print-color-adjust: exact;}}" +
        "</style>" +
        "</head>" +
